            ...
            <div class="row">
                <div class="col-sm-8 d-flex flex-column flex-sm-row align-items-center fs-2">
                    ...
                    <div class="text-container ml-3">
                        <p class="fs-5 fw-bold mb-0">Edit Galeri</p>
                    </div>
                </div>
            </div>
        </div>
          ...
          <div class="card mb-3 p-4" style="max-width: 75%;">
            <form action="{{ route('admin.updateGaleri', $galeri->id) }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="row d-flex align-items-center mb-3">
                    ...
                    <div class="col-md-10">
                        <input type="text" class="form-control @error('judulGaleri') is-invalid @enderror" id="judulGaleri" name="judulGaleri" value="{{ old('judulGaleri', $galeri->judulGaleri) }}" placeholder="Masukkan judul">
                        @error('judulGaleri')
                ...
                <div class="row d-flex align-items-center mb-3">
                    ...
                    <div class="col-md-10">
                        <div class="form-check">
                            <input class="form-check-input @error('kategoriGaleri') is-invalid @enderror" type="radio" name="kategoriGaleri" id="flexRadioDefault1" value="Foto" {{ $galeri->kategoriGaleri == 'Foto' ? 'checked' : '' }} onclick="toggleInput()">
                            <label class="form-check-label" for="flexRadioDefault1">Foto</label>
                        </div>
                        <div class="form-check">
                            <input class="form-check-input @error('kategoriGaleri') is-invalid @enderror" type="radio" name="kategoriGaleri" id="flexRadioDefault2" value="Video" {{ $galeri->kategoriGaleri == 'Video' ? 'checked' : '' }} onclick="toggleInput()">
                        ...
                        <div id="fotoInput" class="mt-3" style="{{ $galeri->kategoriGaleri == 'Foto' ? 'display: block;' : 'display: none;' }}">
                        ...
                        <div id="videoInput" class="mt-3" style="{{ $galeri->kategoriGaleri == 'Video' ? 'display: block;' : 'display: none;' }}">
                            <label for="videoKonten" class="form-label">Masukkan URL Video</label>
                            <input type="text" class="form-control @error('videoKonten') is-invalid @enderror" id="videoKonten" name="videoKonten" value="{{ old('videoKonten', $galeri->videoKonten) }}" placeholder="Masukkan URL Vidio">
                            @error('videoKonten')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
