    ...
    <div class="panel-header panel-header-lg">
        <div class="container">
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb">
                    <li class="breadcrumb-item"><a href="{{route('admin.program')}}">Pembayaran</a></li>
            ...
            <div class="row">
                <div class="col-sm-8 d-flex flex-column flex-sm-row align-items-center fs-2">
                    ...
                    <div class="text-container ml-3">
                        <p class="fs-5 fw-bold mb-0">Tambah Pembayaran</p>
                    </div>
                </div>
            </div>
        </div>
        <div class="container d-flex justify-content-center">
            <div class="card mb-3 p-4" style="max-width: 75%;">
              <form action="{{route('admin.pembayaranStore')}}" method="POST" enctype="multipart/form-data">
                @csrf
    
                <div class="row d-flex align-items-center mb-3">
                    <div class="col-md-2">
                        <label for="namaBank" class="form-label fw-bold text-dark">Nama Bank</label>
                    </div>
                    <div class="col-md-10">
                        <input type="text" class="form-control @error('namaBank') is-invalid @enderror" id="namaBank" name="namaBank" value="{{ old('namaBank') }}" placeholder="Masukkan Nama Bank">
                        @error('namaBank')
                ...
                <div class="row d-flex align-items-center mb-3">
                    ...
                    <div class="col-md-10">
                      <input type="text" class="form-control @error('noRek') is-invalid @enderror" id="noRek" name="noRek" value="{{ old('noRek') }}" placeholder="Masukkan nomor rekwning">
                      @error('noRek')
                          <div class="invalid-feedback">{{ $message }}</div>
                      @enderror
                  </div>
                ...
                <div class="row d-flex align-items-center mb-4">
                    ...
                    <div class="col-md-10">
                        <textarea class="form-control @error('petunjuk') is-invalid @enderror" name="petunjuk" id="petunjuk" rows="5"  placeholder="Masukkan petunjuk">{{ old('petunjuk') }}</textarea>
                        @error('petunjuk')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
