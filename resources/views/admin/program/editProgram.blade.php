    ...
    <div class="panel-header panel-header-lg">
            ...
            <div class="row">
                <div class="col-sm-8 d-flex flex-column flex-sm-row align-items-center fs-2">
                    ...
                    <div class="text-container ml-3">
                        <p class="fs-5 fw-bold mb-0">Edit Program</p>
                    </div>
                </div>
            </div>
        </div>
        <div class="container d-flex justify-content-center">
          <div class="card mb-3 p-4" style="max-width: 75%;">
            <form action="{{route('admin.updateProgram',$program->id)}}" method="POST" enctype="multipart/form-data">
                @csrf
                @method('PUT')
                ...
                <div class="row d-flex align-items-center mb-3">
                    ...
                    <div class="col-md-10">
                        <input type="text" class="form-control @error('namaProgram') is-invalid @enderror" id="namaProgram" name="namaProgram" value="{{ old('namaProgram', $program->namaProgram) }}" placeholder="Masukkan Nama Program">
                        @error('namaProgram')
                ...
                <div class="row d-flex align-items-center mb-3">
                    ...
                    <div class="col-md-10">
                      <input type="text" class="form-control @error('jenisProgram') is-invalid @enderror" id="jenisProgram" name="jenisProgram" value="{{ old('jenisProgram', $program->jenisProgram) }}" placeholder="Masukkan Jenis Program">
                      @error('jenisProgram')
                          <div class="invalid-feedback">{{ $message }}</div>
                      @enderror
                  </div>
                ...
                <div class="row d-flex align-items-center mb-4">
                    ...
                    <div class="col-md-10">
                        <textarea class="form-control @error('detailProgram') is-invalid @enderror" id="detailProgram" name="detailProgram" placeholder="Masukkan detail">{{ old('detailProgram', $program->detailProgram) }}</textarea>
                        @error('detailProgram')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
