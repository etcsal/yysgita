                ...
                <ul class="nav nav-pills nav-flush flex-column mb-auto">
                    <li class="{{ (Route::is('admin.dashboard')) ? 'list-active' : ''}}">
                        <a href="{{route('admin.dashboard')}}" class="d-flex align-items-center">
                            ...
                            <p class=" ml-3 fw-bold" >Dashboard / Konten</p>
                        </a>
                    </li>
                    ...
                    <li class="{{ (Route::is('admin.kandidatWinner')) ? 'list-active' : ''}}">
                        <a href="{{route('admin.kandidatWinner')}}" class="d-flex align-items-center">
                            <i class="bi bi-trophy-fill"></i>
                            <p class=" ml-3 fw-bold" >Manajemen Pemenang</p>
                        </a>
                    </li> --}}
                    <li class="">
